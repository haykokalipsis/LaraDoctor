...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <!-- TODO Replace this with my session flash component -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="department_id" class="form-control @error('department') is-invalid @enderror">
                                        <option value="">Please select</option>
                                        <!-- TODO return this from controller -->
...
{{--                                        <button class="btn btn-primary file-upload-browse" type="button">Browse photo</button>--}}
{{--                                    </span>--}}
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="about" rows="4" name="description">{{old('description')}}</textarea>
