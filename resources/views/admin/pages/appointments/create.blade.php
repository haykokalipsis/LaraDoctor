            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span style="margin-left: 700px">
                        ...
                        <input
                            type="checkbox"
                            onclick="checkUncheckAllTimes(this)">
...
@push('scripts')
    <script>
        ...
        function checkUncheckAllTimes(globalCheckbox) {
            for(singleCheckbox in document.getElementsByName('time[]')) {
                document.getElementsByName('time[]').item(singleCheckbox).checked = globalCheckbox.checked;
            }
        }
    </script>
@endpush
