                ...
                @if(auth()->check()&& auth()->user()->role->name === 'admin')
                    <div class="nav-item has-sub">
                        ...
                        <div class="submenu-content">
                            <a href="{{route('departments.create')}}" class="menu-item">Create</a>
                            <a href="{{route('departments.index')}}" class="menu-item">View</a>
                ...
                @if(auth()->check()&& auth()->user()->role->name === 'doctor')
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Appointment Time</span> <span
                                class="badge badge-danger"></span></a>
                        <div class="submenu-content">
                            <a href="{{route('appointments.create')}}" class="menu-item">Create</a>
                            <a href="{{route('appointments.index')}}" class="menu-item">Check</a>
                        </div>
                    </div>
                @endif
